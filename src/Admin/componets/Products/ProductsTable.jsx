        ...
        {/* <Grid container spacing={2}>
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value={"pant"}>Women's Earring</MenuItem>
                <MenuItem value={"mens_kurta"}>Women's Accesories</MenuItem>
                <MenuItem value={"saree"}>Women's Necklace</MenuItem>
                <MenuItem value={"lengha_choli"}>Men's Accesories</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={4}>
